...
function AlertPolice()
    ...
    --     jobs = {["police"] = true},
    --     code = "11-08",
    --     callname = "Assalto ao Banco",
    --     coords = pos,
    --     info = {{
    --         icon = "fas fa-bell",
    --         label = "O banco está sendo roubado. Solicitando reforços!"
    --     }},
...
function Drill(index, k)
    ...
    local item = exports.ox_inventory:Search('count', Config['FleecaMain']['requiredItems'][1])
    if item <= 0 then 
        QBCore.Functions.Notify(Strings['need_item'] .. "drill" , 'error', 3500)
        return end
    local item2 = exports.ox_inventory:Search('count', Config['FleecaMain']['requiredItems'][2])
    if item2 <= 0 then 
        QBCore.Functions.Notify(Strings['need_item'] .. "lockpick" , 'error', 3500)
        return end
